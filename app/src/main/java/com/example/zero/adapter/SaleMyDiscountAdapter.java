...
public class SaleMyDiscountAdapter extends RecyclerView.Adapter<SaleMyDiscountAdapter.SaleViewHolder> {

    private Context context;
    private List<SaleBean> dataList;

    public SaleMyDiscountAdapter(Context context, List<SaleBean> dataList) {
        this.context = context;
        this.dataList = dataList;
    }

    @Override
    public SaleMyDiscountAdapter.SaleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SaleMyDiscountAdapter.SaleViewHolder(LayoutInflater.from(context).inflate(R.layout.fragment_sale_mydiscount, parent, false));
    }

    @Override
    public void onBindViewHolder(SaleMyDiscountAdapter.SaleViewHolder holder, int position) {
